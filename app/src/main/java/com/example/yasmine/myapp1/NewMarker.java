...
public class NewMarker extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMapLongClickListener {
    ...
    public void onMapLongClick(LatLng point) {
        ...
        s.putExtra("lat", point.latitude);
        s.putExtra("lon",point.longitude);
        startActivity(s);
